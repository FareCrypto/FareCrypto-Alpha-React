...
import './z3-stg-index.css'

const Z3StgIndex = (props) => {
  return (
    <div className="z3-stg-index-container1">
      <Helmet>
        <title>z3-stg-index - FareCrypto.net</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="z3-stg-index - FareCrypto.net" />
        <meta
      ...
      <img
        ...
        className="z3-stg-index-image"
      />
      <div id="stg-page" className="z3-stg-index-body body">
        <div className="z3-stg-index-container2 wide_container">
          <div className="z3-stg-index-container3">
            <svg
              viewBox="0 0 1024 1024"
              className="z3-stg-index-icon1 wip-rot-plus"
            >
            ...
            <svg
              viewBox="0 0 1024 1024"
              className="z3-stg-index-icon3 wip-rot-minus"
            >
          ...
          <h1 className="z3-stg-index-text1 FLX_h1_small">
            <span className="z3-stg-index-text2">Area</span>
            <span> in costruzione</span>
          </h1>
          <div className="z3-stg-index-container4">
            <div className="z3-stg-index-container5">
              <React.Fragment>
                <React.Fragment>
                  <style
