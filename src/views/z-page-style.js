...
import './z-page-style.css'

const ZPageStyle = (props) => {
  return (
    <div className="z-page-style-container1">
      <Helmet>
        <title>z-page-style - FareCrypto.net</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="z-page-style - FareCrypto.net" />
        <meta
      ...
      <img
        ...
        className="z-page-style-image"
      />
      <div className="z-page-style-body body">
        <div className="z-page-style-container2 wide_container">
          <div className="z-page-style-container3">
            <svg
              viewBox="0 0 1024 1024"
              className="z-page-style-icon1 wip-rot-plus"
            >
            ...
            <svg
              viewBox="0 0 1024 1024"
              className="z-page-style-icon3 wip-rot-minus"
            >
          ...
          <h1 className="z-page-style-text1 FLX_h1_small">
            <span className="z-page-style-text2">Area</span>
            <span> in costruzione</span>
          </h1>
          <div className="z-page-style-container4">
            <div className="z-page-style-container5">
              <React.Fragment>
                <React.Fragment>
                  <style
